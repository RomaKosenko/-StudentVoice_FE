...
const FAVORITED_CLASS = "btn btn-sm btn-info";
const NOT_FAVORITED_CLASS = "btn btn-sm btn-outline-info";
            ...
            return (
              <Link href={`/?tag=${tag}`} as={`/?tag=${tag}`} key={index}>
                <li
                  ...
                  style={{
                    borderColor:
                      hover && currentIndex === index ? "#2780ff" : "initial",
                  }}
                >
                  <span
                    style={{
                      color:
                        hover && currentIndex === index ? "#2780ff" : "inherit",
                    }}
                    onClick={() => setPage(0)}
                  >
                    {tag}
